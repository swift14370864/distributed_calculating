...
d_model1_1_1.add(Reshape([2,128,1], input_shape=[2,128], name='d_reshape1'))
d_model1_1_1.add(ZeroPadding2D((0,2), name='padding1_1'))
d_model1_1_1.add(Conv2D(256, (1, 3), strides=1, input_shape = [2,132,1], padding='valid', activation='relu', name='d_conv1_1', kernel_initializer='glorot_uniform'))
# d_model1_1_1.summary()
d_model1_1_1.load_weights('./model/d_model1_1_1.h5')

d_model1_1_2 = models.Sequential()
d_model1_1_2.add(Reshape([2,130,64], input_shape=[2,130,64], name='d_reshape1'))
d_model1_1_2.add(ZeroPadding2D((0,2), name='padding1_2'))
d_model1_1_2.add(Conv2D(80, (2, 3), strides=1, input_shape = [2,134,64], padding='valid', activation='relu', name='d_conv2_1', kernel_initializer='glorot_uniform'))
d_model1_1_2.add(Flatten(name='flatten1'))
# d_model1_1_2.summary()
d_model1_1_2.load_weights('./model/d_model1_1_2.h5')

d_model1_1_3 = models.Sequential()
d_model1_1_3.add(Reshape([2640,], input_shape=[2640,], name='d_reshape1'))
d_model1_1_3.add((Dense(256, activation='relu', kernel_initializer='he_normal', name='dense1')))
# d_model1_1_3.summary()
d_model1_1_3.load_weights('./model/d_model1_1_3.h5')

d_model1_1_4 = models.Sequential()
d_model1_1_4.add(Reshape([64,], input_shape=[64,], name='d_reshape1'))
d_model1_1_4.add((Dense(11, activation='softmax', kernel_initializer='he_normal', name='dense2')))
# d_model1_1_4.summary()
d_model1_1_4.load_weights('./model/d_model1_1_4.h5')
...
def cal1(matrix):
    ...
    global d_model1_1_2
    output = d_model1_1_2.predict(matrix, steps = 1)
    # output = output.numpy()
    return output
...
def cal2(matrix):
    matrix = tf.convert_to_tensor(matrix)
    global d_model1_1_3
    output = d_model1_1_3.predict(matrix, steps = 1)
    # output = output.numpy()
    return output
...
def cal3(matrix):
    matrix = tf.convert_to_tensor(matrix)
    global d_model1_1_4
    output = d_model1_1_4.predict(matrix, steps = 1)
    # output = output.numpy()
    return output


output1 = X_test[0:1]
output2 = d_model1_1_1.predict(output1)
##对output2的通信操作
...
# ##
# output3 = d_model1_1_2.predict(tele_output2)
# ##对output3的通信操作

# tele_output3 = [0,0,0,0,0]
# ##
# output4 = d_model1_1_3.predict(tele_output3)
# ##对output4的通信操作

# tele_output4 = [0,0,0,0,0]
# ##
# output5 = d_model1_1_4.predict(tele_output4)
##对output5的通信操作
