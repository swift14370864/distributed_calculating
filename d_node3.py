# -*- coding: utf-8 -*-
"""
Created on Sun Jun  7 20:24:03 2020
这个节点作为客户端
@author: yzy86
"""
...
# n_reshape1 = d_model1_2_1.get_layer('d_reshape1')
# n_padding1 = d_model1_2_1.get_layer('padding1_1')
# n_conv1 = d_model1_2_1.get_layer('d_conv1_1')
...
def send_msg():
    ...
    matrix = output2
    trans_list = matrix.tolist()
    print('transfering', len(trans_list), 'data to server.')
    json_string = json.dumps(trans_list)
...
# ##
# output3 = d_model1_2_2.predict(tele_output2)
# ##对output3的通信操作

# tele_output3 = [0,0,0,0,0]
# ##
# output4 = d_model1_2_3.predict(tele_output3)
# ##对output4的通信操作

# tele_output4 = [0,0,0,0,0]
# ##
# output5 = d_model1_2_4.predict(tele_output4)
##对output5的通信操作
